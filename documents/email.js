...
const emailTemplate = ({ dueDate, type, balanceDue, company, link, id }) => {
...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    Number(balanceDue) <= 0 ? "" : moment(dueDate).format("MMM Do YYYY")
      ...
      <div class"footer">
          <a href="https://billing-web-app.netlify.app">
          <img class="footer-logo" src="https://i.postimg.cc/hGZKzdkS/logo.png" alt="arc-invoice"/>
        </a>
      </div>
    <p style="text-align: center">Make beautiful invoice for free at https://billing-web-app.netlify.app </p>
    </div>
    </body>
</html>`;
};
